                ...
                <div class="d-flex flex-column flex-md-row align-items-center justify-content-between">
                    <div class="d-flex flex-column flex-md-row align-items-center gap-3 w-100">
                        ...
                        <form class="d-flex w-100" action="#" method="GET">
                            <input class="form-control me-2" type="search" placeholder="Cari jurusan..." name="query">
                    ...
                    <div class="mt-3 mt-md-0">
                        <a href="#" class="btn btn-primary"><i class="bi bi-plus me-1"></i>Tambah Jurusan</a>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-flex align-items-center text-decoration-none">
                                                <img src="{{ $jrs['image'] }}" class="rounded me-3" width="72" height="72" alt="Jurusan image">
                                                <div>
                                                    <h5 class="mb-1">{{ $jrs['nama'] }}</h5>
                                                    <div class="text-muted small d-flex flex-wrap gap-3">
                                                        <span><i class="bi bi-calendar me-1"></i>{{ $jrs['tanggal_dibuka'] }}</span>
                                                        <span><i class="bi bi-people me-1"></i>{{ $jrs['jumlah_siswa'] }} Siswa</span>
                                                    </div>
                                                </div>
                                            </a>
                                        </div>
                    ...
                    @else
                        <div class="col-12">
                            <div class="alert alert-warning" role="alert">
                                Tidak ada jurusan (TAMBAHAN BIAR BERHASIL PUSH).
                            </div>
                        </div>
                    @endif
                </div>
