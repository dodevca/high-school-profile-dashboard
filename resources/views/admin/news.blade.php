        ...
        <div class="col-12">
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-between mb-3">
                <form id="searchForm" class="input-group mb-3 mb-md-0 w-100" style="max-width: 360px;" role="search">
                    <input id="searchInput" type="search" class="form-control" placeholder="Cari berita..." aria-label="Search">
                                        ...
                                        <div class="card-body">\
                                            <div class="d-flex flex-wrap align-items-center justify-content-between">\
                                                ...
                                                <div class="d-flex align-items-center mt-3 mt-md-0">\
                                                    <a href="/admin/berita/'+item.id+'" class="btn btn-outline-warning btn-sm me-2"><i class="bx bx-edit-alt me-2"></i>Edit</a>\
