        ...
        <div class="col-12">
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-between mb-3">
                <form id="searchForm" class="input-group mb-3 mb-md-0 w-100" style="max-width: 360px;" role="search">
                    <input id="searchInput" type="search" class="form-control" placeholder="Cari pengumuman..." aria-label="Search">
            ...
            $.getJSON("{{ route('api.admin.announcement.index') }}", {
                ...
                if (res.data.length === 0) {
                    ...
                    res.data.forEach(function(item){
                        var majorBadge = item.major ? '<span class="badge text-bg-secondary">' + item.major_code + '</span>' : '<span class="badge text-bg-secondary">Semua Jurusan</span>';
                        var card = '\
                            <div class="col-lg-12 mb-3">\
                                <div class="card">\
                                    <div class="card-body d-flex justify-content-between align-items-center">\
                                        ...
                                        <div class="d-flex">\
                                            <a href="/admin/pengumuman/'+item.id+'" class="btn btn-outline-warning btn-sm me-2"><i class="bx bx-edit-alt me-2"></i> Edit</a>\
