            ...
            <nav id="navbar" class="navbar fw-bold">
                <ul>
                    ...
                    <li class="dropdown"><a href="#"><span>Akademik</span><i class="bi bi-chevron-down"></i></a>
                        @if($school->major->count())
                            <ul>
                                @foreach($school->major as $major)
                                    <li><a class="{{ (request()->routeIs('module') && request()->route('hash') === $major->code) ? 'active' : '' }}" href="{{ route('module', $major->code) }}">{{ $major->name }}</a></li>
                                @endforeach
                            </ul>
                        @endif
                    </li>
            ...
            <div class="row gy-4 align-items-center">
                ...
                <div class="col-md-6">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a class="text-light text-decoration-none" href="{{ route('event.index') }}">Agenda</a></li>
